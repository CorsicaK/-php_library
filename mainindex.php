...
<body>
    ...
    <header>
        ...
        <div class="wrapper">
            <a href="" class="logo"> <img src="images/library.png" alt="" /> </a>
            <nav>
                <ul>
                    <li><a href="mainindex.php">刷新</a></li>
    ...
    <section class="billboard" >
        <section class="caption">
            <p class="cap_title">学而不厌，诲人不倦！——孔丘</p>
            
        </section>
    </section>

<tr><td><iframe src="mainindexshow.php" width=100% height=600></iframe></td></tr>

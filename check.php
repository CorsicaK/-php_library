...
<body>
	...
	<header>
		...
		<div class="wrapper">
			<a href="" class="logo"> <img src="images/checkchaxun.png" alt="" /> </a>
			<nav>
				<ul>
					<li><a href="check.php">刷新</a></li>
	...
	<section class="billboard" >
		<section class="caption">
			<p class="cap_title">读书补天然之不足，经验又补读书之不足。——培根</p>
			
		</section>
	</section>

   <tr><td><iframe src="checkshow.php" width=100% height=400></iframe></td></tr>

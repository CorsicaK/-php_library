...
<body>
	...
	<header>
		...
		<div class="wrapper">
			<a href="" class="logo"> <img src="images/yonghushenhe.png" alt="" /> </a>
			<nav>
				<ul>
					<li><a href="user_sh.php">刷新</a></li>
	...
	<section class="billboard" >
		<section class="caption">
			<p class="cap_title">人的影响短暂而微弱，书的影响则广泛而深远。——普希金</p>
			
		</section>
	</section>

<tr><td><iframe src="usersh.php" width=100% height=550></iframe></td></tr>
